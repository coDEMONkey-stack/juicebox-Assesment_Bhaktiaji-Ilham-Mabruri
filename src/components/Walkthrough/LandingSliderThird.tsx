...
const LandingSliderThird: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="mt-20 flex gap-4 text-center justify-center items-center py-6 px-2 sm:px-10">
        ...
        >
          <h1>
            You&apos;ll get insights into current<br className="hidden sm:block"/>
            industry sentiments and a reality <br className="hidden sm:block"/>
            check about technology in a few<br className="hidden sm:block"/>
            minutes. Deal? Great!.
          </h1>
...
export default LandingSliderThird;
