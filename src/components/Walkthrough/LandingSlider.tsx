  ...
  return (
    <>
      ...
      <div className="mt-20 flex gap-4 text-center justify-center items-center py-6 px-2 sm:px-10">
        ...
        >
          <h1>
            Professionals around the world <br className="hidden sm:block"/>
            shared how they feel about <br className="hidden sm:block"/>
            technology  and I&apos;ve listened. <br className="hidden sm:block"/>
            Now it&apos;s your turn.
          </h1>
        </div>
      </div>
