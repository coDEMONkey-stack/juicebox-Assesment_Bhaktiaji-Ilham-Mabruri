    ...
    return (
        <>
            ...
            <div className="mt-2 flex gap-4 text-center justify-center items-center py-6 px-2 sm:px-10">
                ...
                >
                    <h1 className="split-text">
                        {name ? `Thanks ${name}! Now, it’s time` : "Thanks! Now, it’s time"} <br className="hidden sm:block" />
                        to get a reality check. <br className="hidden sm:block mb-1" />
            ...
            <div className="mt-11 flex gap-4 text-center justify-center items-center py-6 px-4">
                <Link href="#">
                    <button className="secondary-button text-md sm:text-3xl p-30 sm:px-72">
                        Continue
                    </button>
                </Link>
            </div>
